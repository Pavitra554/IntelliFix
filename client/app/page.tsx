  ...
  return (
    <main className="min-h-screen p-4 pt-0">
        ...
        <div className="max-w-3xl mx-auto w-full flex flex-col items-start space-y-8">
          ...
          <div className="flex flex-col space-y-8">
            <div className="flex flex-col space-y-1">
              <div className="text-xl md:text-4xl font-extrabold">Where Precision Meets Code.</div>
      ...
      <section className="max-w-5xl mx-auto relative my-10">
        ...
        <div className="relative dark:bg-black bg-white w-full h-[70vh] border flex justify-center items-center rounded-lg text-xl font-bold">Platform image / demo video will be added here 🚀</div>
      </section>
      <section>
