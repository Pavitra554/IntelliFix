    ...
    <div className=" min-h-screen flex justify-center items-center p-4">
      ...
      <div className="relative">
        ...
        <div className="relative dark:bg-zinc-950/80 bg-white max-w-md  w-full flex flex-col gap-2 items-center p-6 border rounded-lg shadow-lg">
          ...
          />
          <div className="text-lg md:text-4xl font-extrabold tracking-wide mt-4`">
            Welcome to IntelliFix
          </div>
          <div className="text-zinc-500 text-center text-xs md:text-base">
            Where code meets precision effortlessly. Experience seamless
            debugging with AI-powered optimization. Join us and elevate your
            coding journey. Welcome to a new era of development
          </div>
